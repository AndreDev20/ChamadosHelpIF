...
public class AdminController {
    ...
    public String salvarIncidente(@PathVariable Long id,
        ...
        incidenteService.atualizar(id, observacao, bloco, localEspecifico, categoria, tipo, status,
                responsavel, observacaoTecnica);
    ...
    public String criarUsuario(@RequestParam String nome,
                               ...
                               Model model) {
        try {
            usuarioService.criar(nome, email, senha, role, tipo);
            return "redirect:/admin";
        } catch (Exception e) {
    ...
    public String salvarUsuario(@PathVariable Long id,
                                @RequestParam String nome,
                                @RequestParam String email,
                                @RequestParam Role role,
                                @RequestParam(required = false) TipoManutencao tipo) {
        usuarioService.atualizar(id, nome, email, role, tipo);
        return "redirect:/admin";
    }
    ...
    private void preencherOpcoesUsuario(Model model) {
